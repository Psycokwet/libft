...
OBJBONUS		=	$(SRCBONUS:.c=.o) 					## get all .o names from .c names
...
$(BONUS)	:	$(OBJBONUS) $(NAME)
		$(CC) -o $(BONUS) $(OBJBONUS) $(LDFLAGS) $(CFLAGS)
...
rebo	:	fclean $(BONUS)							## delete all .o and recompile all. Must use when editing a .h
